...
- Mid-circuit measurement plus classical control flow is limited to simple Qiskit `if_test` / `if_else`, finite `for_loop`, and `switch_case` sampling trajectories; broader while-loop and classical-control semantics remain absent.
