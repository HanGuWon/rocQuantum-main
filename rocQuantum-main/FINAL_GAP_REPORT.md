...
- only a narrow mid-circuit measurement and classical-control story: Qiskit simple `if_test` / `if_else` and `switch_case` sampling trajectories work, but loop/estimator/statevector dynamic semantics remain open
