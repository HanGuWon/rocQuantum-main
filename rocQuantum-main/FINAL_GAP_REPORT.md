...
- only a narrow mid-circuit measurement and classical-control story: Qiskit simple `if_test` / `if_else` sampling trajectories work, but loop/switch/estimator/statevector dynamic semantics remain open
