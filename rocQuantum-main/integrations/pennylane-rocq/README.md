...
- **Projector Readouts**: Computational-basis `qml.Projector` expectation and variance expand to Pauli-Z product terms without statevector readback; variance uses the projector idempotence relation `P^2=P`, including compatible `batch_execute`, instead of building a separate Pauli-square readout plan.
