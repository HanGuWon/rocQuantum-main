...
- **Native Select Decomposition**: Dispatches full `qml.Select` blocks through native controlled single-qubit operations or the small controlled-matrix hook for selected target operators, with batched selected rotation angles when compatible.
