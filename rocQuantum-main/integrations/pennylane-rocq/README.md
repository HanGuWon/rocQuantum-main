...
- **Native Pauli Rotation Decomposition**: Dispatches `qml.MultiRZ` and `qml.PauliRot` as basis changes plus a CNOT-chain and native `RZ`, avoiding dense matrix upload for common Pauli-rotation ansatz blocks.
