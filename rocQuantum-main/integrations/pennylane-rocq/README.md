...
- **GPU Matrix Fallbacks**: Dispatches common PennyLane matrix-defined gates such as non-default-control `MultiControlledX` and `OrbitalRotation` through rocQuantum matrix application instead of decomposing them into longer gate sequences.
