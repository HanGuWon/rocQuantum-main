...
- **GPU Matrix Fallbacks**: Dispatches remaining PennyLane matrix-defined gates such as non-default-control `MultiControlledX`, `DoubleExcitationPlus/Minus`, and explicit unitary operations through rocQuantum matrix application instead of rejecting them.
