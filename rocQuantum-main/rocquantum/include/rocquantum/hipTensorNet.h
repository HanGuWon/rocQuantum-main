 ...
 * Decomposes A into U * S * Vh, where Vh is the conjugate transpose of V.
 *
 ...
 * @param[out] Vh The resulting unitary matrix V^H, matching rocSOLVER's
 *                row-wise right-singular-vector output contract.
