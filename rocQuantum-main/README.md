...
| Top-level `rocq` | Canonical runtime path with native execute/sample/observe wiring, coefficient-preserving composite observable sums, numeric identity constants, and Pauli-product terms in operator arithmetic |
