...
- Native density-matrix core with named noise channels, generic single- and multi-qubit Kraus channel APIs, and density sampling with GPU-side marginal probability reduction
...
| Higher-level helpers | Experimental VQE objective/gradient, VQE-compatible MaxCut-style QAOA kernel/cost/solve helper, and 3-qubit repetition-code single/repeated-round helpers with syndrome/correction analysis |
