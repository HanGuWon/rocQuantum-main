...
- PennyLane computational-basis `qml.Projector` variance now uses `P^2=P` after lowering the projector to Pauli-Z terms, including compatible `batch_execute`, avoiding a separate Pauli-square readout plan.
