...
- `compile_and_execute()` for a narrow MLIR subset: qalloc, H/X/Y/Z/S/Sdg/T, CNOT/CZ/SWAP, RX/RY/RZ, CRX/CRY/CRZ
...
| `rocqCompiler` | Partial codegen path plus a narrow compile-and-execute MVP for qalloc/H/X/Y/Z/S/Sdg/T/CNOT/CZ/SWAP/RX/RY/RZ/CRX/CRY/CRZ |
...
- `rocqCompiler::MLIRCompiler::compile_and_execute()` executes only the current MVP subset: qalloc, H/X/Y/Z/S/Sdg/T, CNOT/CZ/SWAP, RX/RY/RZ, CRX/CRY/CRZ. Unsupported compiler ops raise diagnostics.
