...
| Higher-level helpers | Experimental VQE objective/gradient, VQE-compatible MaxCut-style QAOA helper, and 3-qubit repetition-code single/repeated-round helpers with syndrome/correction analysis |
