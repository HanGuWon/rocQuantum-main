...
| Top-level `rocq` | Canonical runtime path with native execute/sample/observe wiring, coefficient-preserving composite observable sums, and numeric identity constants in operator arithmetic |
