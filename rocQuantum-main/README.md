...
| --- | --- |
| `hipStateVec` | Real and useful, with local batched state allocation/readback plus batched probabilities and Pauli expectations exposed through `QuantumSimulator`; not yet fully surfaced through every framework adapter |
