...
| --- | --- |
| `hipStateVec` | Real and useful, with local batched state allocation/readback and batched probabilities exposed through `QuantumSimulator` and legacy `python/rocq`; not yet fully surfaced through every framework adapter |
