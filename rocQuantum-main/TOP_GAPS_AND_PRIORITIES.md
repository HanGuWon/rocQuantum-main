...
9. Framework integrations now cover native sampling, native Pauli-observable paths, default multi-control gate dispatch, and selected sparse-observable correctness fallbacks for PennyLane/Qiskit more directly, but still rely on mock-heavy tests rather than strong native ROCm end-to-end proof.
