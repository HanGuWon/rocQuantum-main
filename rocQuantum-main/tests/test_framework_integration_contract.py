...
class TestFrameworkIntegrationContract(unittest.TestCase):
    ...
    def test_public_simulator_exposes_sparse_hamiltonian_moments(self):
        ...
        self.assertIn("binding adjoint_jacobian currently supports full-state CSR sparse observables only", bindings)
        self.assertIn("trainable_rotation_generator", bindings)
        self.assertIn("binding adjoint_jacobian currently differentiates trainable RX/RY/RZ/CRX/CRY/CRZ", bindings)
